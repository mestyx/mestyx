<div align="center">
  ...
  **À partir de problématiques métier, je conçois des systèmes clé en main (app + infra) en m'appuyant sur une stack IA et du self-hosting pour garder le contrôle des données et la fiabilité en production.**
  ...
  <img src="./assets/banner-infra.svg" alt="Topologie d'infrastructure self-hosted, motif de grille et nœuds connectés" width="100%">
...
![Dokploy](https://img.shields.io/badge/Dokploy-4F46E5?style=flat-square)
![Traefik](https://img.shields.io/badge/Traefik-24D1C6?style=flat-square&logo=traefikproxy&logoColor=white)
...
![Qdrant](https://img.shields.io/badge/Qdrant-FD3A5C?style=flat-square&logo=qdrant&logoColor=white)
